...
hose {
    ...
    KMS_UTILS = '0.4.0'
    BASEIMG = 'qa.stratio.com/stratio/spark-stratio-driver:2.2.0-2.4.0-70f0925'
    ...
    INSTALLPARAMETERS = """
            ...
            | -DCROSSDATA_SERVER_CONFIG_SPARK_IMAGE=qa.stratio.com/stratio/spark-stratio-driver:2.2.0-2.4.0-70f0925
            | -DROLE_SPARTA=open
