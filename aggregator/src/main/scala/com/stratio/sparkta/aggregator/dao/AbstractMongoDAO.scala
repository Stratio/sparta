...
import com.stratio.sparkta.aggregator.dao.AbstractMongoDAO._
...
private object AbstractMongoDAO {
  ...
  private[aggregator] def client(mongoClientUri: String): MongoClient = {
  ...
  private[aggregator] def db(mongoClientUri: String, dbName: String): MongoDB = {
