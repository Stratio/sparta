...
case class QRThresholdResults(thresholdSatisfied: Boolean, thresholdCondition: String,thresholdActionType: SpartaQualityRuleThresholdActionType, qualityRuleType: QualityRuleType = Reactive)