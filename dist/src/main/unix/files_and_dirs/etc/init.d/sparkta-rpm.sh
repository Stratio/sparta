...
# Default-Stop:      0 1 6
# Short-Description: Starts Sparkta
# Description:       Starts Sparkta real time aggregation engine
### END INIT INFO
...
NAME="sparkta"
DESC="Sparkta real time aggregation engine"
