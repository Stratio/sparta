...
SPARTA_MARATHON_OPTIONS="$SPARTA_MARATHON_CONF_PROPERTY $MARATHON_APP_HEAP_MINIMUM_SIZE $MARATHON_APP_HEAP_SIZE $SPARTA_MARATHON_JVM_UNLOCK_EXPERIMENTAL_OPTIONS $SPARTA_MARATHON_JVM_SUMMARY $SPARTA_MARATHON_JVM_USE_CGROUP_MEMORY_LIMIT $SPARTA_MARATHON_JVM_GARBAGE_COLLECTOR"
