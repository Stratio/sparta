...
SPARTA_MARATHON_JVM_OOM_ERROR="-XX:OnOutOfMemoryError="\""echo 'Sparta MarathonDriver has run out of memory'"\"

SPARTA_MARATHON_JVM_SUMMARY="-XX:NativeMemoryTracking=summary"

SPARTA_MARATHON_OPTIONS="$SPARTA_MARATHON_CONF_PROPERTY $MARATHON_APP_HEAP_MINIMUM_SIZE $MARATHON_APP_HEAP_SIZE $SPARTA_MARATHON_JVM_SUMMARY $SPARTA_MARATHON_JVM_OOM_ERROR"
