...
object SpartaToGoSecConversions {
  ...
  implicit def actionConversion(spartaAction: SpartaAction): Action = spartaAction match {
    ...
    case SpartaWorkflowStatus => Status
