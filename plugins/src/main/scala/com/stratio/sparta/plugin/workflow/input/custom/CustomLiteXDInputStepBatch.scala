...
import com.stratio.sparta.sdk.lite.xd.batch.LiteCustomXDBatchInput
...
class CustomLiteXDInputStepBatch(
                                name: String,
  ...
  def customStep: Try[LiteCustomXDBatchInput] = Try {
    ...
    classpathUtils.tryToInstantiate[LiteCustomXDBatchInput](
      ...
      block = (c) => {
        ...
        instance.asInstanceOf[LiteCustomXDBatchInput]
      },
