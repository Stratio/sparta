...
import com.stratio.sparta.sdk.lite.xd.streaming.LiteCustomXDStreamingInput
...
class CustomLiteXDInputStepStreaming(
                                    name: String,
  ...
  def customStep: Try[LiteCustomXDStreamingInput] = Try {
    ...
    classpathUtils.tryToInstantiate[LiteCustomXDStreamingInput](
      ...
      block = (c) => {
        ...
        instance.asInstanceOf[LiteCustomXDStreamingInput]
      },
