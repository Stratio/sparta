...
//scalastyle:off
class AddColumnTransformStepStreaming(
                                                 name: String,
  ...
  extends AddColumnTransformStep[DStream](name, outputOptions, transformationStepsManagement, ssc, xDSession, properties) {
