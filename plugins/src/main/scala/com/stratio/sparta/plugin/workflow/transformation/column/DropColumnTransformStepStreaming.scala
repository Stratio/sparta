...
//scalastyle:off
class DropColumnTransformStepStreaming(
                                        name: String,
  ...
  extends DropColumnTransformStep[DStream](name, outputOptions, transformationStepsManagement, ssc, xDSession, properties) {
