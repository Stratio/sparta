...
import com.stratio.sparta.sdk.lite.batch.LiteCustomBatchTransform
...
class CustomLiteTransformStepBatch(
                                    name: String,
  ...
  def customStep: Try[LiteCustomBatchTransform] = Try {
    ...
    classpathUtils.tryToInstantiate[LiteCustomBatchTransform](
      ...
      block = (c) => {
        ...
        instance.asInstanceOf[LiteCustomBatchTransform]
      },
