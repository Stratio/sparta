...
class CustomLiteXDTransformStepStreaming(
                                          name: String,
  ...
  def customStep: Try[LiteCustomXDStreamingTransform] = Try {
    ...
    classpathUtils.tryToInstantiate[LiteCustomXDStreamingTransform](
      ...
      block = (c) => {
        ...
        val instance = constructor.newInstance(xDSession, ssc.get, properties)

        instance.asInstanceOf[LiteCustomXDStreamingTransform]
      },
