...
case class DateTimeItemModel(inputField: Option[String] = None,
                             formatFrom: String,
                             userFormat: Option[String]= None,
                             standardFormat: Option[String]= None,
                             localeTime: Option[String] = None ,
                             granularityNumber: Option[String] = None,
                             granularityTime: Option[String] = None,
                             fieldsPreservationPolicy: String,
                             outputFieldName: String,
                             outputFieldType: String,
                             nullable: Option[Boolean] = None,
                             outputFormatFrom: String,
