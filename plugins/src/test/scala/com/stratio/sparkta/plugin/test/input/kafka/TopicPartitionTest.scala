 ...
 */
package com.stratio.sparkta.plugin.test.input.kafka

import com.stratio.sparkta.plugin.input.kafka.KafkaInput
...
class TopicPartitionTest extends WordSpec with Matchers{
