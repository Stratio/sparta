 ...
 */
package com.stratio.sparkta.plugin.test.operator.max

import com.stratio.sparkta.plugin.operator.max.MaxOperator
...
class MaxOperatorTest extends WordSpec with Matchers {
  ...
  "Max operator" should {
    ...
    "processMap must be " in {
      ...
      val inputFields5 = new MaxOperator("max", initSchema, Map("inputField" -> "field1"))
