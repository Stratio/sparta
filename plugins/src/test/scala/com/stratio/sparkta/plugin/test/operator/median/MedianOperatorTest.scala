...
package com.stratio.sparkta.plugin.test.operator.median

import com.stratio.sparkta.plugin.operator.median.MedianOperator
...
class MedianOperatorTest extends WordSpec with Matchers {
  ...
  "Median operator" should {
    ...
    "processMap must be " in {
      ...
      val inputFields5 = new MedianOperator("median", initSchema, Map("inputField" -> "field1"))
