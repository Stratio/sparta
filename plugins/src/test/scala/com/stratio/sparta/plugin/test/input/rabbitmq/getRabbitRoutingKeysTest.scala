 ...
 */
package com.stratio.sparta.plugin.test.input.rabbitmq

import com.stratio.sparta.plugin.input.rabbitmq.RabbitMQInput
import com.stratio.sparta.sdk.JsoneyString
import org.scalatest.{Matchers, WordSpec}


class getRabbitRoutingKeysTest extends WordSpec with Matchers {
