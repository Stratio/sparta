...
class GBTRegressorTest extends GenericPipelineStepTest {


  override def stepName: String = "gbtregressor"

  override def resourcesPath: String = "/mlpipeline/singlesteps/algorithms/gbtregressor/"
  ...
  override def trainingDf: DataFrame = {
    ...
    sparkSession.createDataFrame(sparkSession.sparkContext.parallelize(generateOrderedLabeledPoints(numFeatures = 10, 50)))
  }
}
