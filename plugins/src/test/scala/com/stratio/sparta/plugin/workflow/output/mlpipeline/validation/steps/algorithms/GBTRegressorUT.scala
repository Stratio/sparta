...
class GBTRegressorUT extends GenericPipelineStepTest {
  ...
  override def trainingDf: DataFrame = {
    ...
    sparkSession.createDataFrame(sparkSession.sparkContext.parallelize(generateOrderedLabeledPoints(numFeatures = 20, 500)))
  }
}
