...
class GaussianMixtureTest extends GenericPipelineStepTest {


  override def stepName: String = "gaussianmixture"

  override def resourcesPath: String = "/mlpipeline/singlesteps/algorithms/gaussianmixture/"
