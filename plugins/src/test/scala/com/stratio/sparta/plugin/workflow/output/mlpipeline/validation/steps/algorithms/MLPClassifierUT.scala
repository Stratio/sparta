...
import com.stratio.sparta.plugin.workflow.output.mlpipeline.validation.GenericPipelineStepTestMissingDefault
...
class MLPClassifierUT extends GenericPipelineStepTestMissingDefault {
