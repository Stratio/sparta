...
class RFClassifierTest extends GenericPipelineStepTest {


  override def stepName: String = "rfclassifier"

  override def resourcesPath: String = "/mlpipeline/singlesteps/algorithms/rfclassifier/"
