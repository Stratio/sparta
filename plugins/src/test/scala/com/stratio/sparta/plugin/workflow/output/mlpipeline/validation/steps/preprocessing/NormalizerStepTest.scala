...
class NormalizerStepTest extends GenericPipelineStepTest {

  override def stepName: String = "normalizer"

  override def resourcesPath: String = "/mlpipeline/singlesteps/preprocessing/normalizer/"
