...
class OneHotEncoderStepTest extends GenericPipelineStepTest {

  override def stepName: String = "onehotencoder"

  override def resourcesPath: String = "/mlpipeline/singlesteps/preprocessing/onehotencoder/"
