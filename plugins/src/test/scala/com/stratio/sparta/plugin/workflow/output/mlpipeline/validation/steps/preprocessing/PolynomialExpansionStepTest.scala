...
class PolynomialExpansionStepTest extends GenericPipelineStepTest {

  override def stepName: String = "pol-expansion"

  override def resourcesPath: String = "/mlpipeline/singlesteps/preprocessing/pol-expansion/"
