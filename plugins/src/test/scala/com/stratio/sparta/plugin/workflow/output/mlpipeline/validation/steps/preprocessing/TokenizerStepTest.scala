...
class TokenizerStepTest extends GenericPipelineStepTest {

  override def stepName: String = "tokenizer"

  override def resourcesPath: String = "/mlpipeline/singlesteps/preprocessing/tokenizer/"
