...
class DateTimeTransformStepTest extends WordSpecLike
  ...
  "A DateTimeTransform" should {
    ...
    "parse unix to string" in {
      ...
      val expected = Seq(new GenericRowWithSchema(Array(1416330788000L, "1416330788000"), schemaExpected))
    ...
    "throw an error if the policy has not a valid granularity" in {
      val input = new GenericRowWithSchema(Array("2015-11-08 15:58:58"), schemaInput)
      val fieldsDatetime =
        """[{
          |"inputField":"ts",
