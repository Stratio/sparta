...
class DropColumnsTransformStepBatchIT extends TemporalSparkContext with Matchers with DistributedMonadImplicits {
  ...
  "A DropColumnTransformStepBatchIT" should "drop columns from the schema" in {
    ...
    val result = new DropColumnsTransformStepBatch(
      "dummy",
      outputOptions,
