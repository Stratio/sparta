...
object CastingUtils {
  ...
  def checkStructType(origValue: Any): Any = origValue match {
  ...
  def checkArrayStructType(origValue: Any): Any = origValue match {
  ...
  def checkArrayStringType(origValue: Any): Any = origValue match {
  ...
  def checkArrayIntType(origValue: Any): Any = origValue match {
  ...
  def checkArrayLongType(origValue: Any): Any = origValue match {
  ...
  def checkArrayDoubleType(origValue: Any): Any = origValue match {
  ...
  def checkArrayMapStringStringType(origValue: Any): Any = origValue match {
  ...
  def checkMapStringStructType(origValue: Any): Any = origValue match {
  ...
  def checkMapStringStringType(origValue: Any): Any = origValue match {
  ...
  def checkMapStringIntType(origValue: Any): Any = origValue match {
    case value: util.Map[_, _] => value.asScala.map(cast =>
      cast._1.toString -> {
  ...
  def checkMapStringLongType(origValue: Any): Any = origValue match {
    case value: util.Map[_, _] => value.asScala.map(cast =>
      cast._1.toString -> {
  ...
  def checkMapStringDoubleType(origValue: Any): Any = origValue match {
    case value: util.Map[_, _] => value.asScala.map(cast =>
      cast._1.toString -> {
  ...
  def checkArrayByteType(origValue: Any): Any = origValue match {
  ...
  def checkStringType(origValue: Any): Any = origValue match {
  ...
  def checkTimestampType(origValue: Any): Any = origValue match {
  ...
  def checkDateType(origValue: Any): Any = origValue match {
  ...
  def checkDateTimeType(origValue: Any): Any = origValue match {
    case value: DateTime => value
    case value: Timestamp => new DateTime(value.getTime)
    case value: Date => new DateTime(value.getTime)
    case value: Long => new DateTime(value)
    case value: JString => new DateTime(value.s)
    case value: Array[Byte] => new DateTime(new Predef.String(value))
    case value if value == null => null
    case _ => new DateTime(origValue.toString)
  }

  def checkLongType(origValue: Any): Any = origValue match {
  ...
  def checkDoubleType(origValue: Any): Any = origValue match {
  ...
  def checkShortType(origValue: Any): Any = origValue match {
  ...
  def checkFloatType(origValue: Any): Any = origValue match {
  ...
  def checkIntType(origValue: Any): Any = origValue match {
  ...
  def checkByteType(origValue: Any): Any = origValue match {
    case value if value.isInstanceOf[Byte] => value
    case value if value == null => null
    case _ => origValue.toString.toByte
  }

  def checkBooleanType(origValue: Any): Any = origValue match {
