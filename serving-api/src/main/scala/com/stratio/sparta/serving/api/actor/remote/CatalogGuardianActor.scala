...
class CatalogGuardianActor extends GuardianActor {

  lazy val instanceConfig = SpartaConfig.getCatalogConfig().get
  ...
  lazy val rocketMode = RocketModes.Catalog

}

object CatalogGuardianActor {

  def props: Props = Props[CatalogGuardianActor]
