...
class DebugGuardianActor extends GuardianActor {

  lazy val instanceConfig = SpartaConfig.getDebugConfig().get
  ...
  lazy val rocketMode = RocketModes.Debug

}

object DebugGuardianActor {

  def props: Props = Props[DebugGuardianActor]
