...
/**
 * Sparkta's ConfigFactory wrapper around Java's ConfigFactory used in SparktaHelper.
 */
class SparktaConfigFactory extends ConfigFactory {}

/**
 * Sparkta's ConfigFactory wrapper used as a mock in SparktaHelperSpec.
