...
import com.stratio.sparta.serving.core.utils.EnvironmentCleanerUtils

class EnvironmentCleanerActor extends Actor {

  private val utils = new EnvironmentCleanerUtils(context.system, ActorMaterializer())

  override def receive: Receive = {
    case TriggerCleaning =>
      utils.removeFromDCOS
  }
}
