...
object AppConstant extends ZookeeperUtils {
  ...
  val DefaultEnvironment = Seq(
    ...
    EnvironmentVariable("SPARK_DRIVER_JAVA_OPTIONS","-Dconfig.file=/etc/sds/sparta/reference.conf -XX:+UseConcMarkSweepGC -Dlog4j.configurationFile=file:///etc/sds/sparta/log4j2.xml"),
