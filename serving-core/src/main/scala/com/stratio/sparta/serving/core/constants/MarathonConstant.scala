...
object MarathonConstant {
  ...
  val SpartaLogAppender = "LOG_APPENDER"
  val BashLogLevelEnv = "BASH_LOG_LEVEL"
  ...
  val HttpLogLevelEnv = "HTTP_LOG_LEVEL"
  val SpartaRedirectorEnv = "SPARTA_REDIRECTOR_LOG_LEVEL"
  ...
  val CrossdataSecurityManagerEnabled = "CROSSDATA_SECURITY_MANAGER_ENABLED"
  val CrossdataSecurityManagerClass = "CROSSDATA_SECURITY_MANAGER_CLASS"
  val CrossdataStoragePath = "CROSSDATA_STORAGE_PATH"
  val CrossdataCoreStoragePersistence = "CROSSDATA_STORAGE_PERSISTENCE"
