...
public class SpartaLauncher {
   ...
   */
  public SpartaLauncher(Map<String, String> env) {
   ...
   */
  public SpartaLauncher setJavaHome(String javaHome) {
   ...
   * @return This launcher.
   */
  public SpartaLauncher setSparkHome(String sparkHome) {
   ...
   * @return This launcher.
   */
  public SpartaLauncher setPropertiesFile(String path) {
   ...
   * @return This launcher.
   */
  public SpartaLauncher setConf(String key, String value) {
   ...
   * @return This launcher.
   */
  public SpartaLauncher setAppName(String appName) {
   ...
   * @return This launcher.
   */
  public SpartaLauncher setMaster(String master) {
   ...
   * @return This launcher.
   */
  public SpartaLauncher setDeployMode(String mode) {
   ...
   * @return This launcher.
   */
  public SpartaLauncher setAppResource(String resource) {
   ...
   * @return This launcher.
   */
  public SpartaLauncher setMainClass(String mainClass) {
   ...
   * @return This launcher.
   */
  public SpartaLauncher addSparkArg(String arg) {
   ...
   * @return This launcher.
   */
  public SpartaLauncher addSparkArg(String name, String value) {
   ...
   * @return This launcher.
   */
  public SpartaLauncher addAppArgs(String... args) {
    for (String arg : args) {
   ...
   * @return This launcher.
   */
  public SpartaLauncher addJar(String jar) {
   ...
   * @return This launcher.
   */
  public SpartaLauncher addFile(String file) {
   ...
   * @return This launcher.
   */
  public SpartaLauncher addPyFile(String file) {
    checkNotNull(file, "file");
   ...
   * @return This launcher.
   */
  public SpartaLauncher setVerbose(boolean verbose) {
   ...
   * @return This launcher.
   */
  public SpartaLauncher directory(File dir) {
    workingDir = dir;
    return this;
  }
   ...
   * @return This launcher.
   */
  public SpartaLauncher redirectError() {
   ...
   * @return This launcher.
   */
  public SpartaLauncher redirectError(ProcessBuilder.Redirect to) {
    errorStream = to;
    return this;
  }
   ...
   * @return This launcher.
   */
  public SpartaLauncher redirectOutput(ProcessBuilder.Redirect to) {
    outputStream = to;
    return this;
  }
   ...
   * @return This launcher.
   */
  public SpartaLauncher redirectError(File errFile) {
   ...
   * @return This launcher.
   */
  public SpartaLauncher redirectOutput(File outFile) {
   ...
   * @return This launcher.
   */
  public SpartaLauncher redirectToLog(String loggerName) {
  ...
  public SparkAppHandle startApplication(SparkAppHandle.Listener... listeners) throws IOException {
    SpartaChildProcAppHandle handle = SpartaLauncherServer.newAppHandle();
    ...
    pb.environment().put(LauncherProtocol.ENV_LAUNCHER_PORT,
      String.valueOf(SpartaLauncherServer.getServerInstance().getPort()));
