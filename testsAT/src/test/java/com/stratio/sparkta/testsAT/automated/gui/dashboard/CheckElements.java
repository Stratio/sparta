package com.stratio.sparkta.testsAT.automated.gui.dashboard;
...
@CucumberOptions(features = { "src/test/resources/features/automated/gui/dashboard/checkElementsDashboard.feature" })
