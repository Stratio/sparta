...
public class SPARTA_1279_KafkaPostgres_fullSec_IT extends BaseTest {

    @Factory(enabled = false, dataProviderClass = BrowsersDataProvider.class, dataProvider = "availableUniqueBrowsers")
    public SPARTA_1279_KafkaPostgres_fullSec_IT(String browser) {
        this.browser = browser;
    }

    @Test(enabled = true, groups = {"postgres_kafka_fullsec"})
