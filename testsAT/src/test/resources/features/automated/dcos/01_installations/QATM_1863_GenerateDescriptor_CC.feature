...
Feature: [QATM_1863] Generate New CommandCenter Descriptor with Special Configuration
  ...
  Scenario: [QATM-1863] Generate New Descriptor for CommandCenter
    ...
    When I send a 'POST' request to '/service/deploy-api/universe/sparta/${FLAVOUR}-auto8/descriptor' based on 'schemas/sparta-descriptor.json' as 'json' with:
      | $.data.model                                 | REPLACE | ${FLAVOUR}-auto8                                                  | string |
