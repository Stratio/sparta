Feature: [SPARTA-1278] Add Initial Configuration for Sparta
  ...
  Scenario:[SPARTA-1278][02]Modify registerService.xml for sparta Auth in all master agents
    ...
    # mvn verify -DCLUSTER_ID=newcore -DURL_GOSEC=/opt/stratio/gosec-sso/conf -DDCOS_SERVICE_NAME=sparta-dg -DCLIENTSECRET=LBNuJVgfsb-WHEkP83zt -DMASTERS_LIST=10.200.1.244,10.200.1.30,10.200.1.236 -DPRIVATE_AGENTS_LIST=10.200.1.238,10.200.1.173,10.200.1.53,10.200.1.51,10.200.1.184 -DDCOS_CLI_HOST=dcos-nigthly.demo.stratio.com -Dit.test=com.stratio.sparta.testsAT.automated.dcos.installations.SPARTA_1273_AddConfigurationForSparta_IT -DIDNODE=526
    # mvn verify -DCLUSTER_ID=megadev -DURL_GOSEC=/opt/stratio/gosec-sso/conf -DDCOS_SERVICE_NAME=sparta-dg -DCLIENTSECRET=LBNuJVgfsb-WHEkP83zt -DMASTERS_LIST=10.200.0.21 -DPRIVATE_AGENTS_LIST=10.200.0.54,10.200.0.55,10.200.0.56,10.200.0.57,10.200.0.58,10.200.0.59,10.200.0.60,10.200.0.61,10.200.0.69,10.200.0.70,10.200.0.71,10.200.0.72 -DDCOS_CLI_HOST=dcos-nigthly.demo.stratio.com -Dit.test=com.stratio.sparta.testsAT.automated.dcos.installations.SPARTA_1273_AddConfigurationForSparta_IT -DIDNODE=527
