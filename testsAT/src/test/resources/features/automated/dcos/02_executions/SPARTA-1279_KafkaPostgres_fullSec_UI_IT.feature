...
Feature: [QATM-1863] E2E Execution of Workflow Kafka Postgres x Elements with all security enabled
  ...
  Scenario: [QATM-1863][15] generate file for import workflow with visual interface
    Given I create file 'kafkapostgres.json' based on 'schemas/workflows/kafka-postgres.json' as 'json' with:
    ...
    When I outbound copy 'target/test-classes/kafkapostgres.json' through a ssh connection to '/tmp'
    Given I run 'cat /tmp/kafkapostgres.json' in the ssh connection and save the value in environment variable 'workflowKafkaPostgres'
  ...
  Scenario:[QATM-1863][15] Install kafka-postgres workflow
    ...
    When I securely browse to '/${DCOS_SERVICE_NAME}/#/repository'
    And I wait '2' seconds
    Then '1' elements exists with 'id:create-entity-button'
    When I click on the element on index '0'
    And I wait '2' seconds
    Then '1' elements exists with 'xpath://div[@id='file-option']/span[2]'
    When I click on the element on index '0'
#    And '1' elements exists with 'id:components-textarea-template'
#    And I type element with variable '!{workflowKafkaPostgres}' on the element on index '0'
#    And I wait '10' seconds
    Then '1' elements exists with 'xpath://input[@type='file']'
    And I type '/tmp/kafkapostgres.json' on the element on index '0'
    And I wait '2' seconds
    Then '1' elements exists with 'id:save-button'
    When I click on the element on index '0'
