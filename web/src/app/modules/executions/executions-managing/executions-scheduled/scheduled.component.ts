...
export class ScheduledComponent {
  ...
  @Input() sidebarExecutionDetail: ScheduledExecution;
  ...
  constructor(private _cd: ChangeDetectorRef) {
    this.fields = [
      ...
      { id: 'uniqueInstance', label: 'Unique instance'},
  ...
  selectedExecutionAction(event, execution: ScheduledExecution) {
    switch(event) {
      case 'scheduled-desactivate':
        this.stopExecution.emit(execution);
        break;
      case 'scheduled-activate':
