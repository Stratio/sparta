...
@Component({
  ...
  template: `
    <scheduled-list
      ...
      [sidebarExecutionDetail]="sidebarExecutionDetail$ | async"
...
export class ScheduledContainer implements OnInit, OnDestroy {
  ...
  public sidebarExecutionDetail$: Observable<ScheduledExecution>;
  ...
  ngOnInit(): void {
    ...
    this.sidebarExecutionDetail$ = this._store.pipe(select(fromRoot.getSidebarExecutionDetail));
  }
