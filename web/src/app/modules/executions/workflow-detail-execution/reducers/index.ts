...
export function workflowDetailExecutionReducer(state: WorkflowDetail = initialState, action: workflowDetailActions.Actions): WorkflowDetail {
  switch (action.type) {
...
export const getWorkflowState = createFeatureSelector<WorkflowState>('workflowDetailExecution');

export const workflowDetailExecutionReducers = {
  workflowDetail: workflowDetailExecutionReducer
};
