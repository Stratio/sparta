...
import { MENU_OPTIONS, RUN_OPTIONS, MENU_OPTIONS_DUPLICATE } from './repository-header-menus.model';
...
export class RepositoryHeaderComponent implements OnChanges, OnDestroy {
