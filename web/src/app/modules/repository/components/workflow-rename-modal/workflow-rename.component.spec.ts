...
import { WorkflowRenameModalComponent } from './workflow-rename.component';
...
describe('[WorkflowsRenameModalComponent]', () => {
   let component: WorkflowRenameModalComponent;
   let fixture: ComponentFixture<WorkflowRenameModalComponent>;
   ...
   beforeEach(async(() => {
      TestBed.configureTestingModule({
         declarations: [WorkflowRenameModalComponent],
         imports: [
            FormsModule,
            SpInputModule,
            TranslateMockModule
   ...
   beforeEach(() => {
      fixture = TestBed.createComponent(WorkflowRenameModalComponent);
