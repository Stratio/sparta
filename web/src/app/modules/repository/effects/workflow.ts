...
export class WorkflowEffect {
   ...
   getWorkflowListAndStatus$: Observable<Action> = this.actions$
      ...
      .pipe(withLatestFrom(this.store.select(fromRoot.getCurrentLevel)))
   ...
   deleteSingleFolder$: Observable<Action> = this.actions$
      ...
      .pipe(map(action => action.groupId))
      .pipe(switchMap((id: string) => this.workflowService.deleteGroupById(id)
         ...
         .catch((error) => of(new workflowActions.DeleteSingleGroupErrorAction()))));
   ...
   deleteSingleWorkflow$: Observable<Action> = this.actions$
      ...
      .pipe(map(action => action.workflowName))
      .pipe(withLatestFrom(this.store.select(fromRoot.getWorkflowList)))
      .pipe(switchMap(([workflowName, workflowList]: [string, Array<GroupWorkflow>]) => {
         ...
         return this.workflowService.deleteWorkflowList(list)
            ...
            .catch((error) => of(new workflowActions.DeleteSingleWorkflowErrorAction()));
      }));

   @Effect()
   deleteVersions$: Observable<Action> = this.actions$
      .ofType<workflowActions.DeleteVersionAction>(workflowActions.DELETE_VERSION)
      .pipe(withLatestFrom(this.store.select(fromRoot.getSelectedVersions)))
      .pipe(switchMap(([data, selectedVersions]) =>
         this.workflowService.deleteWorkflowList(selectedVersions)
            ...
            .catch(error => from([new workflowActions.DeleteVersionErrorAction(), new errorActions.ServerErrorAction(error)]))));
   ...
   runWorkflow$: Observable<workflowActions.Actions> = this.actions$
      .ofType<workflowActions.RunWorkflowAction>(workflowActions.RUN_WORKFLOW)
   ...
   createGroup$: Observable<Action> = this.actions$
      ...
      .pipe(map((action: any) => action.payload))
      .pipe(withLatestFrom(this.store.select(fromRoot.getCurrentGroupLevel)))
   ...
   getExecutionContexts$: Observable<Action> = this.actions$
      ...
      .catch(error => of(new workflowActions.ConfigAdvancedExecutionErrorAction()));
