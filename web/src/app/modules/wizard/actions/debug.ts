...
export const EXPORT_DEBUG_SCHEMA = '[Wizard] Export debug schema';
...
export class ExportDebugSchemaAction implements Action {
  readonly type = EXPORT_DEBUG_SCHEMA;
