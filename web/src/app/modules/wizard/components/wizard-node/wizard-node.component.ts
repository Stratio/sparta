...
export class WizardNodeComponent implements OnInit, OnDestroy, AfterContentInit {
   ...
   ngAfterContentInit() {
      ...
      this._ngZone.runOutsideAngular(() => {
         const textContainer = d3Select(this.el.querySelector('.text-container'));
      ...
      this.relationSelector = d3SelectAll(this.el.querySelectorAll(('.relation')));
   ...
   generateEntry() {
      ...
      this.relationSelector.on('mousedown', function () {
         ...
         d3Select(this).classed('over-output2', true);
      ...
      this._ngZone.runOutsideAngular(() => {
         this.relationSelector
            .on('mouseover', function () {
               ...
               d3Select(this).classed('over-output', false);
            });
      });
   }
