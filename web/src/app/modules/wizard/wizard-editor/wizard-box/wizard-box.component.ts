...
import { Component, OnInit, OnDestroy, HostListener, ElementRef, Input, AfterContentInit, ChangeDetectorRef, Output, EventEmitter } from '@angular/core';
...
export class WizardBoxComponent implements OnInit, OnDestroy, AfterContentInit {
    ...
    ngOnInit(): void {
        ...
        switch (this.data.type) {
            case 'input':
                this.strokeColor = '#fcb66c';
                break;
            case 'output':
                this.strokeColor = '#c59ddb';
                break;
            case 'transformation':
                this.strokeColor = '#78c7dd';
                break;
            default:
