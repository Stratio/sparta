...
/** private flags for control session */
let __expiredSession__ = false;
let __successRequests__ = 0;  // count the number of success requests
...
export class ApiService {
  ...
  private _showLoginWindow() {
    ...
    if (!refresh && !__expiredSession__) {
      __expiredSession__ = true;
  ...
  private _redirectToLogin() {
    window.location.href = 'login?' + this.sessionGetParam + '=true';
  }
}
