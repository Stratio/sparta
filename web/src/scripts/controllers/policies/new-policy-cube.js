(function () {
  ...
  angular
    .module('webApp')
    .controller('NewPolicyCubeCtrl', NewPolicyCubeCtrl);

  NewPolicyCubeCtrl.$inject = ['PolicyModelFactory', 'CubeStaticDataFactory', 'AccordionStatusService', '$modal'];

  function NewPolicyCubeCtrl(PolicyModelFactory, CubeStaticDataFactory, AccordionStatusService, $modal) {
    var vm = this;
    vm.init = init;
