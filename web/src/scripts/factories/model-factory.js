...
(function() {
  ...
  ModelFactory.$inject = ['UtilsService'];

  function ModelFactory(UtilsService) {
    var model = {};
    ...
    function isValidModel() {
      var isValid = (model.inputField != "" || isAutoGeneratedDateTime())
          && model.outputFields.length > 0 && model.type != "";
      if (!isValid) {
    ...
    function isAutoGeneratedDateTime(){
      return (model.type === "DateTime" && model.configuration.inputFormat === "autoGenerated") ;
    }
