 ...
 */
export const  WIZARD_STORE_MOCK = {
   wizard: {
      wizard: {
         editionMode: false,
         workflowId: '',
         ...
         settings: {
            ...
            advancedSettings: {
               global: {
                  ...
                  mesosConstraint: null,
                  mesosConstraintOperator: 'CLUSTER',
                  initSqlSentences: null,
                  userPluginsJars: null,
               ...
               streamingSettings: {
                  ...
                  backpressure: null,
                  backpressureInitialRate: null,
                  backpressureMaxRate: null,
                  stopGracefully: true,
                  stopGracefulTimeout: null,
                  checkpointSettings: {
                     enableCheckpointing: true,
                     checkpointPath: '{{{SPARK_STREAMING_CHECKPOINT_PATH}}}',
                     autoDeleteCheckpoint: true,
                     addTimeToCheckpointPath: null
                  }
               },
               sparkSettings: {
                  sparkKerberos: true,
                  ...
                  sparkConf: {
                     ...
                     sparkUser: null,
                     coarse: true,
                     sparkKryoSerialization: null,
                     sparkSqlCaseSensitive: true,
                     logStagesProgress: null,
                     hdfsTokenCache: true
                  }
               },
               errorsManagement: {
      ...
      externalData: {
         environmentVariables: [
            ...
            {
               name: 'JDBC_URL',
               value: 'jdbc:postgresql://dbserver:port/database?user=postgres'
            },
            {
            ...
            {
               name: 'KAFKA_MAX_POLL_TIMEOUT',
               value: '512'
            },
            {
               name: 'KAFKA_MAX_RATE_PER_PARTITION',
               value: '0'
            },
            {
               name: 'MONGODB_DB',
            ...
            {
               name: 'SPARK_DRIVER_JAVA_OPTIONS',
               value: '-Dconfig.file=/etc/sds/sparta/spark/reference.conf -XX:+UseConcMarkSweepGC -Dlog4j.configurationFile=file:///etc/sds/sparta/log4j2.xml'
            },
            {
            ...
            {
               name: 'SPARK_EXECUTOR_BASE_IMAGE',
               value: 'qa.stratio.com/stratio/stratio-spark:2.2.0.5'
            },
            {
            ...
            {
               name: 'SPARK_EXECUTOR_EXTRA_JAVA_OPTIONS',
            ...
            {
               name: 'SPARK_LOCALITY_WAIT',
               value: '100'
            },
            {
               name: 'SPARK_LOCAL_PATH',
            ...
            {
               name: 'SPARK_STREAMING_BLOCK_INTERVAL',
               value: '100ms'
            },
            {
               name: 'SPARK_STREAMING_CHECKPOINT_PATH',
               value: 'sparta/checkpoint'
            },
            {
               name: 'SPARK_STREAMING_WINDOW',
               value: '2s'
            },
            {
               name: 'SPARK_TASK_MAX_FAILURES',
               value: '8'
            },
            {
               name: 'WEBSOCKET_URL',
