describe('API.fragment-service', function () {
  ...
  it("Should create a fragment", function () {
    var newFragmentJSON = {
      "type": "input",
      "id": "2095f20a-fd83-4315-be45-192bc5sEdFff"
    };
  ...
  it("Should delete a fragment by type and by ID", function () {
    var fragmentTypeIdJSON = {
      "type": "output",
      "fragmentId": "2581f20a-fd04-4315-be45-192bc5sEdFff"
    };
