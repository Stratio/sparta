describe('policies.wizard.factory.model-factory', function() {
  ...
  var factory, fakeModel, fakeDateTimeModel, fakeApiDateTime, fakeModelTemplate = null;


  beforeEach(inject(function(ModelFactory, _modelTransformation_, _modelDateTime_, _apiDateTime_, _templatePolicy_) {
